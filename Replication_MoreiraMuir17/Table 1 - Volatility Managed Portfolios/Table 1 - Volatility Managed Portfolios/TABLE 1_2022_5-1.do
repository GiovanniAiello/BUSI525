...
* BUSI525
*********************************
cd "/Users/.../Downloads/Table 1 - Volatility Managed Portfolios"
...
asdoc reg mktrf_1 mktrf, cnames(Mkt)  stat(rmse) replace nest tzok save(Table1.doc)
asdoc reg smb_1 smb, cnames(SMB)  stat(rmse) nest tzok

asdoc reg hml_1 hml, cnames(HML)  stat(rmse) nest tzok
...
asdoc reg cma_1 cma, cnames(CMA)  stat(rmse) nest tzok append nest tzok save(Table1.doc)

asdoc reg rmw_1 rmw, cnames(RMW)  stat(rmse) nest tzok
...
* Appending Table1
asdoc reg mom_1 mom, cnames(MOM)  stat(rmse) append nest tzok save(Table1.doc)
...
* Appending Table1
asdoc reg roe_1 r_roe, cnames(ROE)  stat(rmse) append nest tzok save(Table1.doc)

asdoc reg ia_1 r_ia, cnames(IA)  stat(rmse) nest tzok
...
* Appending Table1
asdoc reg bab_1 bab, cnames(BAB)  stat(rmse) append nest tzok save(Table1.doc)
